...
Examples of required packages, statistical models, and plots used can be seen below. Note: These are generalized examples produced for ease of adaptation. Both  files containing [RNAseq Analysis Code](q.down_trim_map_Carnivora.sh), [Parsing Counts and merging metadata](MergingCounts_toMetadata_2021-06-10), and all [Statistical Analysis/Visualization Code](CrossSpecGraph_Final.Rmd) contains the specific models used for publication.
